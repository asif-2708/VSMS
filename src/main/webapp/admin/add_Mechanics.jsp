...
<title>Add Mechanics - Vehicle Service Management System</title>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Add Mechanics</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Add New Mechanics</h3>
								</div>
								<%
								...
								%>
								<script>
									alert("New Mechanics Add Successfully..");
									window.location
											.assign("manage_Mechanics.jsp");
								</script>
								<%
									}
								%>
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label>Mechanic Email</label> <input type="email"
												...
												placeholder="Enter Mechanic Email" required>
										</div>
