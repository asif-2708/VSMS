...
<title>All Service - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">All Servicing</a></li>
			</ul>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">All Servicing</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">All Servicing</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
							...
							<tbody>
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select servicerequest.Category,servicerequest.ServiceNumber,servicerequest.id, user.FullName,user.MobileNo,user.Email,user.RegDate from servicerequest inner join user on user.Email=servicerequest.Email");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
								<tr>
									...
									<td><a
										...
										class="btn btn-primary"><i class="fas fa-eye"></i></a> <a
										class="btn btn-danger"
										onclick="return confirm('Are you sure to Delete ?')"
										href="deleteService.jsp?id=<%=rs.getInt("id")%>"><i
