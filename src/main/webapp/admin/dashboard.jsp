					...
					<div class="row">
						...
						<div class="col-lg-3 col-6">
							...
							<div class="small-box bg-info">
								...
								<a href="regUser.jsp" class="small-box-footer">More info <i
						...
						<div class="col-lg-3 col-6">
							<%
								int count1 = 0;
									ResultSet rs1 = st.executeQuery("SELECT * from enquiry");
									while (rs1.next()) {
										count1++;
									}
							%>
							...
							<div class="small-box bg-success">
								...
								<a href="allResponse_Enquiry.jsp" class="small-box-footer">More info <i
									class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
						<!-- ./col -->
						<div class="col-lg-3 col-6">
							<%
								int count2 = 0;
									ResultSet rs2 = st.executeQuery("SELECT * from mechanics");
									while (rs2.next()) {
										count2++;
									}
							%>
							...
							<div class="small-box bg-warning">
								...
								<a href="manage_Mechanics.jsp" class="small-box-footer">More
						...
						<div class="col-lg-3 col-6">
							<%
								int count3 = 0;
									ResultSet rs3 = st.executeQuery("SELECT * from servicerequest");
									while (rs3.next()) {
										count3++;
									}
							%>
							...
							<div class="small-box bg-danger">
								...
								<a href="all_Servicing.jsp" class="small-box-footer">More info <i
									class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
						<!-- ./col -->
						...
						<div class="col-lg-3 col-6">
							<%
								int count4 = 0;
									ResultSet rs4 = st.executeQuery("SELECT * from servicerequest where AdminStatus is null");
									while (rs4.next()) {
										count4++;
									}
							%>
							...
							<div class="small-box bg-secondary">
								...
								<a href="new_Service.jsp" class="small-box-footer">More info
						...
						<div class="col-lg-3 col-6">
							<%
								int count5 = 0;
									ResultSet rs5 = st.executeQuery("SELECT * from servicerequest where AdminStatus='Rejected'");
									while (rs5.next()) {
										count5++;
									}
							%>
							...
							<div class="small-box bg-danger">
								<div class="inner">
									...
									<p>Rejected Service Request</p>
								</div>
								<div class="icon">
									<i class="fas fa-cog"></i>
								</div>
								<a href="rejected_Service.jsp" class="small-box-footer">More
									info <i class="fas fa-arrow-circle-right"></i>
								</a>
							</div>
						</div>
						...
						<div class="col-lg-3 col-6">
							<%
								int count6 = 0;
									ResultSet rs6 = st.executeQuery("SELECT * from servicerequest where AdminStatus='Completed'");
									while (rs6.next()) {
										count6++;
									}
							%>
							...
							<div class="small-box bg-info">
								...
								<a href="complete_Servicing.jsp" class="small-box-footer">More
									info <i class="fas fa-arrow-circle-right"></i>
								</a>
							</div>
						</div>
