...
<title>Edit Category - Vehicle Service Management System</title>
	...
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Update Category</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<script>
				...
				window.location.assign("manage_Category.jsp");
			</script>
			<%
				}
			%>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<%
									...
									CategoryDtls p = dao.getCategoryById(id);
								%>
								<!-- form start -->
									...
									<div class="card-body">
										<div class="form-group">
											<label>Category Name</label> <input type="text"
												...
												value="<%=p.getVehicleCat()%>" required>
										</div>
									</div>
