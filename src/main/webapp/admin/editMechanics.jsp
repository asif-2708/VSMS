<!DOCTYPE html>
<%@page import="com.vehicles.MechanicDtls"%>
<%@page import="com.vehicles.DbConnect"%>
<%@page import="com.vehicles.MechanicDAO"%>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Edit Mechanics - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Add Mechanics</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Update Mechanics</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Edit Mechanics</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			%>
			<script>
				alert("Mechanics Updated Successfully");
				window.location.assign("manage_Mechanics.jsp");
			</script>
			<%
				}
			%>
			<!-- Main Form Start content -->
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Edit Mechanics</h3>
								</div>


								<%
									int id = Integer.parseInt(request.getParameter("id"));
									MechanicDAO dao = new MechanicDAO(DbConnect.Connect());
									MechanicDtls p = dao.getMechanicById(id);
								%>
								<!-- form start -->
								<form action="../updateMechanic" method="post">
									...
									<div class="card-body">
										<div class="form-group">
											<label>Mechanic Name</label> <input type="text"
												name="FullName" class="form-control"
												value="<%=p.getFullName()%>" required>
										</div>

										<div class="form-group">
											<label>Mechanic Contact No.</label> <input type="text"
												name="MobileNumber" class="form-control"
												value="<%=p.getMobileNumber()%>" required>
										</div>

										<div class="form-group">
											<label>Mechanic Email</label> <input type="email"
												name="Email" class="form-control" value="<%=p.getEmail()%>"
												required>
										</div>
