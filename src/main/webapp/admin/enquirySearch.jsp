...
<title>Search Enquiry - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Enquiry Search</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Enquiry Search</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="dashboard.jsp">Home</a></li>
								<li class="breadcrumb-item active">Enquiry Search</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Search Enquiry</h3>
								</div>
								...
								<form action="" method="post">
									<div class="card-body">
										<div class="form-group">
											<label>Search by Name / Email id / Contact number:</label> <input
												type="text" name="search" class="form-control"
												placeholder="Enter Name/Email id/Contact number:" required>
										</div>
									</div>
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									...
									try {
										...
										ResultSet rs = st.executeQuery(
												"select enquiry.EnquiryNumber, enquiry.EnquiryType,enquiry.EnquiryDate,enquiry.id, user.FullName,user.MobileNo,user.Email,user.RegDate from enquiry inner join user on user.Email=enquiry.Email where user.FullName like '%"
								...
								<tr>
									<td><%=i%></td>
									<td><%=rs.getString("EnquiryType")%></td>
									<td><%=rs.getInt("EnquiryNumber")%></td>
									<td><%=rs.getString("FullName")%></td>
									<td><%=rs.getString("MobileNo")%></td>
									<td><%=rs.getString("Email")%></td>
									<td><%=rs.getString("EnquiryDate")%></td>
									<td><a href="viewEnquiryDtls.jsp?id=<%=rs.getInt("id")%>"
