<!DOCTYPE html>
<%@page import="com.vehicles.CategoryDAO"%>
<%@page import="com.vehicles.CategoryDtls"%>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Manage Category - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Manage Category</a></li>
			</ul>
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									int i = 0;
									for (CategoryDtls p : CategoryDAO.getCategory(false, false)) {
										i++;
								%>
								<tr>
									<td><%=i%></td>
									<td><%=p.getVehicleCat()%></td>
									<td>
										<div class="btn-group">
											<a class="btn btn-primary"
												href="editCategory.jsp?id=<%=p.getId()%>"><i
												class="fa fa-edit"></i></a> <a class="btn btn-danger"
												onclick="return confirm('Are you sure to Delete ?')"
												href="deleteCategory.jsp?id=<%=p.getId()%>"><i
