...
<title>Manage Mechanics - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Manage Mechanics</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Manage Mechanics</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
			...
			<section class="content">
				...
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Manage Mechanics</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									int i = 0;
									for (MechanicDtls p : MechanicDAO.getMechanics(false, false)) {
										i++;
								%>
								<tr>
									<td><%=i%></td>
									...
									<td>
										<div class="btn-group">
											<a class="btn btn-primary"
												href="editMechanics.jsp?id=<%=p.getId()%>"><i
												class="fa fa-edit"></i></a> <a class="btn btn-danger"
												onclick="return confirm('Are you sure to Delete ?')"
												href="deleteMechanics.jsp?id=<%=p.getId()%>"><i
