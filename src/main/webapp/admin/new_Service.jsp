...
<title>New Service - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">New Service</a></li>
			</ul>
								...
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select servicerequest.Category,servicerequest.ServiceNumber,servicerequest.id, user.FullName,user.MobileNo,user.Email,user.RegDate from servicerequest inner join user on user.Email=servicerequest.Email where servicerequest.AdminStatus is null");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
