...
<title>Not Response Enquiry - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Not Response Enquiry</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Not Response Enquiry</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="dashboard.jsp">Home</a></li>
								<li class="breadcrumb-item active">Customer Enquiry</li>
								<li class="breadcrumb-item active">Not Response Enquiry</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Not Response Enquiry</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
								...
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select enquiry.EnquiryNumber,enquiry.EnquiryType,enquiry.Email,enquiry.EnquiryDate,enquiry.id,user.FullName,user.MobileNo,user.Email,user.RegDate from enquiry inner join user on user.Email=enquiry.Email where enquiry.AdminStatus is null");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
