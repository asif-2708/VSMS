...
<title>Pending Servicing - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Pending Service</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Pending Servicing</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Pending Servicing</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				...
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Pending Servicing</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
								...
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select servicerequest.Category,servicerequest.ServiceNumber,servicerequest.id, user.FullName,user.MobileNo,user.Email,user.RegDate from servicerequest inner join user on user.Email=servicerequest.Email where servicerequest.AdminStatus='Selected'");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
