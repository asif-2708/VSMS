<!DOCTYPE html>
<%@page import="com.vehicles.UserDAO"%>
<%@page import="com.vehicles.UserDtls"%>
<html lang="en">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Register User- Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Register User</a></li>
			</ul>
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									int i = 0;
									for (UserDtls p : UserDAO.getUser(false, false)) {
										i++;
								%>
								<tr>
									<td><%=i%></td>
									...
									<td><a class="btn btn-danger"
										...
										href="deleteUser.jsp?id=<%=p.getId()%>"><i
