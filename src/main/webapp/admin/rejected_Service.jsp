...
<title>Reject Service - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Reject Service</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Rejected Service</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Rejected Service</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Rejected Service Request</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select servicerequest.Category,servicerequest.ServiceNumber,servicerequest.id, user.FullName,user.MobileNo,user.Email,user.RegDate from servicerequest inner join user on user.Email=servicerequest.Email where servicerequest.AdminStatus='Rejected'");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
								<tr>
									...
									<td><a href="viewServiceDtls.jsp?id=<%=rs.getInt("id")%>"
