...
<title>Search Service - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Service Search</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Service Search</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="dashboard.jsp">Home</a></li>
								<li class="breadcrumb-item active">Service Search</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Search Service</h3>
								</div>
								...
								<form action="" method="post">
									<div class="card-body">
										<div class="form-group">
											<label>Search by Service Number / Name/ Email id/ Contact number:</label> <input
												type="text" name="search" class="form-control"
												placeholder="Enter Service Number/ Name/Email id/Contact number:" required>
										</div>
									</div>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									try {
										...
										ResultSet rs = st.executeQuery(
												"select servicerequest.Category,servicerequest.ServiceNumber,servicerequest.id, user.FullName,user.MobileNo,user.Email,user.RegDate from servicerequest inner join user on user.Email=servicerequest.Email where user.FullName like '%"
														+ search + "%' || user.MobileNo like '%" + search + "%' || user.Email like '%" + search
														+ "%' || servicerequest.ServiceNumber like '%" + search + "%'");
										int i = 0;
										while (rs.next()) {
											i++;
								%>
								<tr>
									...
									<td><a
										href="viewServicingDtls.jsp?id=<%=rs.getInt("id")%>"
