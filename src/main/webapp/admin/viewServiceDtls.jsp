...
<title>View Service Details - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">View Service Details</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">View Service Details</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="dashboard.jsp">Home</a></li>
								<li class="breadcrumb-item active">View Service Details</li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<script>
				...
				windows.location("pending_Servicing.jsp");
			</script>
			<%
				}
			%>
					...
					<div class="card-body">
						<table border="1" class="table table-bordered mg-b-0">
							...
							<tr>
								<th>Admin Status</th>
								<%
									if (rs.getString("AdminStatus") == "Selected") {
								%>								
								...
								<%
									if (rs.getString("AdminStatus") =="Rejected") {
								%>
								...
								%>
								<td colspan="3">Wait for Admin approval</td>
								<%
									}
								%>
							</tr>
						...
						<table class="table mb-0">
							...
							<%
								if (rs.getString("AdminStatus") == null) {
							%>
							<form action="updateService.jsp" name="submit" method="post">
								<tr>
									<th>Admin Status :</th>
								...
								<tr align="center">
									<td colspan="2"><button type="submit" name="submit"
											class="btn btn-primary pd-x-20">Service Completed</button></td>
								</tr>
							</form>
							<%
								}
