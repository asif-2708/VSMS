...
<title>Enquiry Form - Vehicle Service Management System</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Enquiry Form</a></li>
			</ul>
		...
		<script>
			...
			window.location.assign("enquiryHistory.jsp");
		</script>
		<%
			}
		%>
								...
								<form action="../addEnquiry" method="post">
									<div class="card-body">
										<div class="form-group">
											<label>Enquiry Form</label> <select name="EnquiryType"
												...
												<%
													try {
														...
														ResultSet rs1 = st1.executeQuery("select * from enquirytype");
														while (rs1.next()) {
												%>
												<option value="<%=rs1.getString("EnquiryType")%>"><%=rs1.getString("EnquiryType")%></option>
												<%
													}
													}
