...
<title>Enquiry History - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Enquiry History</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Enquiry History</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
				...
				<div class="card card-primary">
					...
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<%
									EnquiryDAO dao = new EnquiryDAO(DbConnect.Connect());
									List<EnquiryDtls> list = dao.getAllEnquiry(email);
									for (EnquiryDtls n : list) {
								%>
								<tr>
									<td><%=n.getId()%></td>
									<td><%=n.getEnquiryNumber()%></td>
									<td><%=n.getEnquiryDate()%></td>
									<td><a href="viewEnquiryDtls.jsp?id=<%=n.getId()%>"
