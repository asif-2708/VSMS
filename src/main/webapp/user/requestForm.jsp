...
<title>Request Form - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">Request Form</a></li>
			</ul>
 ...
 %>
		...
		<div class="content-wrapper">
			...
			<script>
				...
				window.location.assign("requestHistory.jsp");
			</script>
			<%
				}
			%>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<form action="../addServiceReq" method="post">
									<div class="card-body">
											...
											<label>Category</label> <select name="Category"
												...
												<%
													try {
														...
														while (rs1.next()) {
												%>
												<option value="<%=rs1.getString("VehicleCat")%>"><%=rs1.getString("VehicleCat")%></option>
												<%
													}
													}
										...
										<div class="form-group">
											<label>Vehicle Name</label> <input type="text"
												name="VehicleName" class="form-control"
												placeholder="Enter Vehicle Name" required>
										</div>

										<div class="form-group">
											<label>Vehicle Model</label> <input type="text"
												name="VehicleModel" class="form-control"
												placeholder="Enter Vehicle Model" required>
										</div>

										<div class="form-group">
											<label>Vehicle Brand</label> <input type="text"
												name="VehicleBrand" class="form-control"
												placeholder="Enter Vehicle Brand" required>
										</div>

										<div class="form-group">
											<label>Vehicle Registration No.</label> <input type="text"
												name="VehicleRegno" class="form-control"
												placeholder="Enter Vehicle Reg No." required>
										</div>

										<div class="form-group">
											<label>Service Date</label> <input type="date"
												name="ServiceDate" class="form-control" required>
										</div>

										<div class="form-group">
											<label>Service Time</label> <input type="time"
												name="ServiceTime" class="form-control" required>
										</div>

										<div class="form-group">
											<label>Delivery Type</label> <select name="DeliveryType"
												id="DeliveryType" class="form-control" required>
										...
										<div class="form-group" id="PickupAdd">
											<label>Pickup Address</label> <input type="text"
												name="PickupAddress" id="PickupAddress" class="form-control">
										</div>
									</div>
		...
		<footer class="main-footer">
			<strong>Copyright &copy; <a href="#">Vehicle
