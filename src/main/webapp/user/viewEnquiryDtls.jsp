...
<title>View Enquiry History - Vehicle Service Management System</title>
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="#"
					class="nav-link">View Enquiry History</a></li>
			</ul>
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">View Enquiry History</h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
			...
			<section class="content">
				<div class="card card-primary">
					<div class="card-header">
						<h3 class="card-title">Enquiry History</h3>
					</div>
					<%
					 ...
					 try{
						 ...
						 ResultSet rs1 = st1.executeQuery("select * from  enquiry where id='"+id+"' and Email='"+email+"'");
					     while(rs1.next()){
					%>
					<div class="card-body">
						<table id="example1" class="table table-bordered table-striped">
							<tr>
								<th>Enquiry Date</th>
								<td><%=rs1.getString("EnquiryDate")%></td>
								
								<th>Enquiry Number</th>
								<td><%=rs1.getString("EnquiryNumber")%></td>
							</tr>
							
							<tr>
								<th>Enquiry Type</th>
								<td><%=rs1.getString("EnquiryType")%></td>
							...
							<tr>
								...
								<%
									if(rs1.getString("AdminResponse")==null){
								%>
								<td colspan="3">Not Update Yet</td>
  								<%
									} else {
  								%>
  								<td colspan="3"><%=rs1.getString("AdminResponse")%></td>
								<%
									}
								%>
							</tr>
